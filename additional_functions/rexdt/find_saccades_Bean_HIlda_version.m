function [starttimes, endtimes, ederiv] = find_saccades( h, v, minwidth, slope )
...
minwidth=30;%for Hilda who had shorter saccade durations
%minwidth=50; % for Bean, who had much longer ones!!
found = 0;
newstartingpoint = 0;
